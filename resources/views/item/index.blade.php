...
<div id="kt_toolbar_container" class="container-xxl d-flex flex-stack flex-wrap">
    ...
    <div class="page-title d-flex flex-column me-3">
        ...
        <ul class="breadcrumb breadcrumb-dot fw-bold text-gray-600 fs-7 my-1">
            ...
            <!--end::Item-->
            <!--begin::Item-->
            <li class="breadcrumb-item text-gray-500">Items</li>
            <!--end::Item-->
            <!--begin::Item-->
...
<div class="content flex-row-fluid" id="kt_content">
        ...
        <div class="card-header border-0 pt-6">
            ...
            <div class="card-title">
                ...
                <div class="d-flex align-items-center position-relative my-1">
                    ...
                    <!--end::Svg Icon-->
                    <input type="text" data-kt-customer-table-filter="search" class="form-control form-control-solid w-250px ps-15" placeholder="Search Items" />
                </div>
                <!--end::Search-->
            </div>
            <!--begin::Card title-->
            ...
            <div class="card-toolbar">
                ...
                <div class="d-flex justify-content-end" data-kt-customer-table-toolbar="base">
                    ...
                    @else
                        <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#kt_modal_add_customer" disabled>Add Item</button>
                    @endif
                    <!--end::Add customer-->
                </div>
                <!--end::Toolbar-->
            ...
            <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_customers_table">
                ...
                <thead>
                    ...
                    <tr class="text-start text-gray-400 fw-bolder fs-7 text-uppercase gs-0">
                        ...
                        <th class="min-w-125px">Taxes</th>
                        <th class="min-w-125px">Markup</th>
                ...
                @foreach ($items as $item)
                    <tr>
                        ...
                        <td>
                            ...
                            @if ($permission % 16 / 8)
                                <span class="text-gray-800 text-hover-primary mb-1" onclick="showItem( {{$item->id}} )">{{ $item->name }}</span>
                            @else
                        ...
                        <!--begin::Email=-->
                        <td>
                            <span class="text-gray-600 text-hover-primary mb-1">${{ $item->rate }}</span>
                        </td>
                        <!--end::Email=-->
                        <!--begin::Company=-->
                        <td>
                        ...
                        <td>
                        @php
                            $decodedMarkups = json_decode($item->markup);
                            $sum = 0;
                            @endphp

                            @if(is_array($decodedMarkups))

                                @foreach ($decodedMarkups as $markup)
                                    @php $sum += $markup->rate; @endphp
                                @endforeach
                        ...
                        <td class="text-end">
                            ...
                            <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4" data-kt-menu="true">
                                ...
                                <div class="menu-item px-3">
                                    @if ($permission % 4 / 2)
                                        <span class="menu-link px-3" onclick="showItem({{ $item->id }})">Edit</span>
                                    @endif
                                </div>
                                <!--end::Menu item-->
                                <!--begin::Menu item-->
                                <div class="menu-item px-3">
                                    @if ($permission % 2)
                                        <span name="{{ $item->id }}" class="menu-link px-3" data-kt-customer-table-filter="delete_row">Delete</span>
                                    @endif
                                </div>
                                <!--end::Menu item-->
                            </div>
    ...
    <div class="modal fade" id="kt_modal_add_customer" tabindex="-1" aria-hidden="true">
        ...
        <div class="modal-dialog modal-dialog-centered mw-650px">
            ...
            <div class="modal-content">
                <!--begin::Form-->
                <form class="form" action="#" id="kt_modal_add_customer_form" data-kt-redirect="/items">
                    <!--begin::Modal header-->
                    @csrf
                    ...
                    <div class="modal-body py-10 px-lg-17">
                        ...
                        <div class="scroll-y me-n7 pe-7" id="kt_modal_add_customer_scroll" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-max-height="auto" data-kt-scroll-dependencies="#kt_modal_add_customer_header" data-kt-scroll-wrappers="#kt_modal_add_customer_scroll" data-kt-scroll-offset="300px">
                            ...
                            <div class="fv-row mb-7">
                                ...
                                <div class="row" id="item_markups">
                                    <div class="col-5 p-1">
                                        <input type="text" class="form-control form-control-solid" value="{{ $markup->name }}" name="markup_name" disabled/>
                                    </div>
                                    <div class="col-5 p-1">
                                        <input type="number" class="form-control form-control-solid" value="{{ $markup->rate }}" name="markup_rate" disabled/>
                                    </div>
                                    <div class="col-1 p-1 d-flex justify-content-center align-items-center">
                                        <div class="form-check form-check-custom form-check-solid form-check-lg">
    ...
    <div class="modal fade" id="kt_modal_edit_item" tabindex="-1" aria-hidden="true">
        ...
        <div class="modal-dialog modal-dialog-centered mw-650px">
            ...
            <div class="modal-content">
                <!--begin::Form-->
                <form class="form" action="#" id="kt_modal_edit_item_form" data-kt-redirect="/items">
                    <!--begin::Modal header-->
                    @csrf
                    <div class="modal-header" id="kt_modal_edit_item_header">
                        <!--begin::Modal title-->
                        <h2 class="fw-bolder">Edit a Item</h2>
                        <!--end::Modal title-->
                        <!--begin::Close-->
                    ...
                    <div class="modal-body py-10 px-lg-17">
                        ...
                        <div class="scroll-y me-n7 pe-7" id="kt_modal_edit_customer_scroll" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-max-height="auto" data-kt-scroll-dependencies="#kt_modal_edit_customer_header" data-kt-scroll-wrappers="#kt_modal_edit_customer_scroll" data-kt-scroll-offset="300px">
                            ...
                            <div class="fv-row mb-7">
                                ...
                                <!--end::Label-->
                                <!--begin::Input-->
                                <div class="row" id="edit_item_taxes">
                                    <div class="col-5 p-1">
                                        <input type="text" class="form-control form-control-solid" placeholder="Tax Name" id="edit_new_tax_name" value="" />
                                    </div>
                                    <div class="col-5 p-1">
                                        <input type="number" class="form-control form-control-solid" placeholder="Tax Rate" id="edit_new_tax_rate" value="" />
                                    </div>
                                    <div class="col-1 p-1">
                                        <div href="#" class="btn btn-icon btn-primary" onclick="editAddTaxes()"><span class="svg-icon svg-icon-1">
                                            <span>
                                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                                                    <rect opacity="0.3" x="2" y="2" width="20" height="20" rx="5" fill="black"></rect>
                                                    <rect x="10.8891" y="17.8033" width="12" height="2" rx="1" transform="rotate(-90 10.8891 17.8033)" fill="black"></rect>
                            ...
                            <div class="fv-row mb-7">
                                ...
                                <!--end::Label-->
                                <!--begin::Input-->
                                <div class="row" id="edit_item_markups">
                                    <div class="col-5 p-1">
                                        <input type="text" class="form-control form-control-solid" placeholder="Markup Name" id="edit_new_markup_name" value="" />
                                    </div>
                                    <div class="col-5 p-1">
                                        <input type="number" class="form-control form-control-solid" placeholder="Markup Rate" id="edit_new_markup_rate" value="" />
                                    </div>
                                    <div class="col-1 p-1">
                                        <div class="btn btn-icon btn-primary" onclick="editAddMarkups()"><span class="svg-icon svg-icon-1">
                                            <span>
                                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                                                    <rect opacity="0.3" x="2" y="2" width="20" height="20" rx="5" fill="black"></rect>
                                                    <rect x="10.8891" y="17.8033" width="12" height="2" rx="1" transform="rotate(-90 10.8891 17.8033)" fill="black"></rect>
...
<script src="assets/js/custom/apps/items/list/export.js"></script>
<script src="assets/js/custom/apps/items/list/list.js"></script>
<script src="assets/js/custom/apps/items/add.js"></script>

<script src="assets/js/my/item/index.js"></script>
@endsection
