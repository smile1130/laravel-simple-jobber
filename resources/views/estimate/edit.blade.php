...
<div id="kt_toolbar_container" class="container-xxl d-flex flex-stack flex-wrap">
    ...
    <div class="page-title d-flex flex-column me-3">
        <!--begin::Title-->
        <h1 class="d-flex text-dark fw-bolder my-1 fs-3">Edit estimate</h1>
        <!--end::Title-->
        <!--begin::Breadcrumb-->
        <ul class="breadcrumb breadcrumb-dot fw-bold text-gray-600 fs-7 my-1">
            ...
            <!--end::Item-->
            <!--begin::Item-->
            <li class="breadcrumb-item text-gray-600">Estimates</li>
            <!--end::Item-->
            <!--begin::Item-->
        ...
        <form class="form" action="#" id="kt_subscriptions_create_new">
                ...
                <div class="card-body pt-0">
                    ...
                    <div class="d-flex align-items-center p-3 mb-2">
                        ...
                        <div class="d-flex flex-column">
                            <!--begin::Name-->
                            <div class="fs-4 fw-bolder text-gray-900 text-hover-primary me-2" id="estimate_customer_name">{{ $invoice->clientName }}</div>
                            <!--end::Name-->
                            <!--begin::Email-->
                            <div class="fw-bold text-gray-600 text-hover-primary" id="estimate_customer_email">{{ $invoice->clientEmail }}</div>
                            <!--end::Email-->
                        </div>
                        <!--end::Info-->
                    </div>
            ...
            <div class="card card-flush pt-3 mb-5 mb-lg-10">
                ...
                <div class="card-header">
                    <!--begin::Card title-->
                    <div class="card-title">
                        <h2 class="fw-bolder">Estimate</h2>
                    </div>
                    <!--begin::Card title-->
                </div>
                <!--end::Card header-->
                ...
                <div class="card-body pt-0">
                    ...
                    <div class="d-flex flex-column mb-10 fv-row">
                        <!--begin::Label-->
                        <div class="fs-5 fw-bolder form-label mb-3">Estimate No
                        ...
                        <!--end::Label-->
                        <input type="text" class="form-control form-control-solid" id="estimate_no" value="{{ $invoice->no }}" />
                    </div>
                    <!--end::Invoice footer-->
                    <div class="d-flex flex-column mb-10 fv-row">
                        <!--begin::Label-->
                        ...
                        <i tabindex="0" class="cursor-pointer fas fa-exclamation-circle ms-2 fs-7" data-bs-toggle="popover" data-bs-trigger="hover focus" data-bs-html="true" data-bs-content="Add an addition invoice footer note."></i></div>
                        <!--end::Label-->
                        <input class="form-control form-control-solid" placeholder="Pick date &amp; time" name="event_datetime" id="kt_modal_add_schedule_datepicker" value="{{ $invoice->dueTo }}"/>
                    </div>
                    <div class="d-flex flex-column mb-10 fv-row">
                        <!--begin::Label-->
                        ...
                        <i tabindex="0" class="cursor-pointer fas fa-exclamation-circle ms-2 fs-7" data-bs-toggle="popover" data-bs-trigger="hover focus" data-bs-html="true" data-bs-content="Add an addition invoice footer note."></i></div>
                        <!--end::Label-->
                        <input type="text" class="form-control form-control-solid" id="estimate_phone" value="{{ $invoice->phone }}" />
                    </div>
                </div>
                <!--end::Card body-->
            </div>
            ...
            <div class="card card-flush pt-3 mb-5 mb-lg-10">
                ...
                <div class="card-body pt-0">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-2">
                            <input type="text" class="form-control form-control-sm form-control-solid text-end" id="subtotal" value="{{ $invoice->subtotal }}" disabled/>
                        </div>
                    </div>
                    <div class="row mb-3">
                        <div class="col-6"></div>
                        ...
                        <div class="col-2">
                            <input type="number" class="form-control form-control-sm form-control-solid text-end" id="final_markup" value="{{ $invoice->markup }}" min="0" max="100"/>
                        </div>
                    </div>
                    <div class="row mb-3">
                        <div class="col-6"></div>
                        ...
                        <div class="col-2 d-flex">
                            <input type="number" class="form-control form-control-sm form-control-solid text-end" id="final_discount" value="{{ $invoice->discount }}"/>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-2">
                            <input type="number" class="form-control form-control-sm form-control-solid text-end" id="deposit" value="{{ $invoice->deposit }}" min="0" max="100"/>
                        </div>
                    </div>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-2">
                            <input type="text" id="total_tax" class="form-control form-control-sm form-control-solid text-end" value="{{ $invoice->tax }}" disabled/>
                        </div>
                    </div>
                    <div class="row mt-3">
                        <div class="col-6"></div>
            ...
            <div class="card card-flush pt-3 mb-5 mb-lg-10">
                ...
                <div class="card-body pt-0">
                    ...
                    <div class="d-flex flex-column mb-5 fv-row rounded-3 p-7 border border-dashed border-gray-300">
                        ...
                        <!--end::Label-->
                        <!--begin::Checkbox-->
                        <input type="text" class="form-control form-control-solid" placeholder="Type your note here" id="estimate_description" value="{{ $invoice->description }}"/>
                        <!--end::Checkbox-->
                    </div>
                    <div class="d-flex flex-column mb-5 fv-row rounded-3 p-7 border border-dashed border-gray-300">
                        <!--begin::Label-->
                    ...
                    <div class="d-flex flex-column mb-5 fv-row rounded-3 p-7 border border-dashed border-gray-300">
                        ...
                        <label class="form-check form-check-custom form-check-solid">
                            <input class="form-check-input" type="checkbox" checked="checked" id="homeowner_finance"/>
            ...
            <div class="card-body pt-0 fs-6">
                ...
                <div class="mb-7">
                    ...
                    <div class="d-flex align-items-center mb-1">
                        <!--begin::Name-->
                        <a class="fw-bolder text-gray-800 text-hover-primary me-2" id="summary_customer_name">{{ $invoice->clientName }}</a>
                        <!--end::Name-->
                        <!--begin::Status-->
                ...
                <div class="mb-7">
                    ...
                    <div class="mb-0">
                        ...
                        <!--end::Plan-->
                        <!--begin::Price-->
                        <span class="fw-bold text-gray-600" id="summary_total_price">{{ $invoice->total }}$</span>
                        <!--end::Price-->
                    </div>
                    <!--end::Details-->
                </div>
                ...
                <!--begin::Actions-->
                <div class="mb-0">
                    <input class="d-none" value="{{$invoice->state}}" id="invoice_state"/>
                    <button type="submit" class="btn btn-primary" id="kt_subscriptions_create_button" onclick="updateEstimate({{ $invoice->id }})">
                        <!--begin::Indicator-->
                        <span class="indicator-label">Save Estimate</span>
