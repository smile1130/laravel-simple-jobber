...
<div id="kt_toolbar_container" class="container-xxl d-flex flex-stack flex-wrap">
    ...
    <div class="page-title d-flex flex-column me-3">
        <!--begin::Title-->
        <h1 class="d-flex text-dark fw-bolder my-1 fs-3">{{ $type }} {{ $parent ? 'Invoices' : 'Estimates' }}</h1>
        <!--end::Title-->
        <!--begin::Breadcrumb-->
        <ul class="breadcrumb breadcrumb-dot fw-bold text-gray-600 fs-7 my-1">
            <!--begin::Item-->
            <li class="breadcrumb-item text-gray-600">
                <a href="/estimates" class="text-gray-600 text-hover-primary">Home</a>
            </li>
            <!--end::Item-->
            <!--begin::Item-->
            @if($parent == 0)
            ...
            @else
            <li class="breadcrumb-item text-gray-600">Invoices</li>
            @endif
            <!--end::Item-->
            <!--begin::Item-->
            <li class="breadcrumb-item text-gray-500">{{ $type }}</li>
            <!--end::Item-->
        </ul>
        <!--end::Breadcrumb-->
    </div>
    ...
    <div class="d-flex align-items-center py-2 py-md-1">
        ...
        <div class="me-3">
            ...
            <!--begin::Menu 1-->
            <div class="menu menu-sub menu-sub-dropdown w-250px w-md-300px" data-kt-menu="true" id="kt_menu_61484d7042c5c">
                <!--begin::Header-->
                <div class="px-7 py-5">
                ...
                <div class="px-7 py-5">
                    ...
                    <div class="mb-10">
                        ...
                        <!--begin::Input-->
                        <div>
                            <select class="form-select form-select-solid" data-kt-select2="true" data-placeholder="Select option" data-dropdown-parent="#kt_menu_61484d7042c5c" data-allow-clear="true">
                                <option></option>
        ...
        @if($parent == 0)
            @if (floor($permission % 8 / 4))
                <a href="/estimates/create?page=Estimate" class="btn btn-primary fw-bolder" id="kt_toolbar_primary_button">Create</a>
            @else
                <span class="btn btn-primary fw-bolder" id="kt_toolbar_primary_button">Create</span>
            @endif
        @else
            @if (floor($permission % 8 / 4))
                <a href="/estimates/create?page=Invoice" class="btn btn-primary fw-bolder" id="kt_toolbar_primary_button">Create</a>
            @else
                <span class="btn btn-primary fw-bolder" id="kt_toolbar_primary_button">Create</span>
            @endif
        @endif
        ...
        <div class="card-header border-0 pt-6">
            ...
            <div class="card-title">
                ...
                <div class="d-flex align-items-center position-relative my-1">
                    ...
                    <!--end::Svg Icon-->
                    <input type="text" data-kt-subscription-table-filter="search" class="form-control form-control-solid w-250px ps-14" placeholder="Search Estimates" />
                </div>
                <!--end::Search-->
            </div>
            <!--begin::Card title-->
            ...
            <div class="card-toolbar">
                ...
                <div class="d-flex justify-content-end" data-kt-subscription-table-toolbar="base">
                    ...
                    @if($parent == 0)
                        @if (floor($permission % 8 / 4))
                            <a href="/estimates/create?page=Estimate" class="btn btn-primary">
                        ...
                        @else
                            <span class="btn btn-primary">
                                ...
                                <!--end::Svg Icon-->Add Estimate</span>
                        @endif
                    @else
                        @if (floor($permission % 8 / 4))
                            <a href="/estimates/create?page=Invoice" class="btn btn-primary">
                                <!--begin::Svg Icon | path: icons/duotune/arrows/arr075.svg-->
                                <span class="svg-icon svg-icon-2">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                                        <rect opacity="0.5" x="11.364" y="20.364" width="16" height="2" rx="1" transform="rotate(-90 11.364 20.364)" fill="black" />
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="form-check form-check-sm form-check-custom form-check-solid">
                                <input class="form-check-input" type="checkbox" value="1" />
                                <input value="{{ $estimate->id }}" class="d-none" id="estimate_id"/>
                            </div>
                        </td>
                        <!--end::Checkbox-->
                        <!--begin::Customer=-->
                        <td>
                            @if (floor($permission % 16 / 8))
                                <a href="/estimates/{{ $estimate->id }}" class="text-gray-800 text-hover-primary mb-1">{{ $estimate->clientName }}</a>
                            @else
                                <span class="text-gray-800 text-hover-primary mb-1">{{ $estimate->clientName }}</span>
                            @endif
                        </td>
                        <!--end::Customer=-->
                        <!--begin::Status=-->
                        <td>
                            ...
                            @elseif($estimate->state == 3)
                                <div class="badge badge-light-danger">Declined</div>
                            @elseif($estimate->state == 4)
                                <div class="badge badge-light-primary">Active</div>
                            @elseif($estimate->state == 5)
                        ...
                        <!--end::Status=-->
                        <!--begin::Billing=-->
                        <td>{{ json_decode($estimate->items)[0]->name }}</td>
                        <!--end::Billing=-->
                        <!--begin::Product=-->
                        ...
                        <td class="text-end">
                            ...
                            <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4" data-kt-menu="true">
                                ...
                                <div class="menu-item px-3">
                                    @if (floor($permission % 16 / 8))
                                        <a href="/estimates/{{ $estimate->id }}" class="menu-link px-3">View</a>
                                    @endif
                                </div>
                                <!--end::Menu item-->
                                <!--begin::Menu item-->
                                <div class="menu-item px-3">
                                    @if (floor($permission % 4 / 2))
                                        <a href="/estimates/{{ $estimate->id }}/edit" class="menu-link px-3">Edit</a>
                                    @endif
                                </div>
                                <!--end::Menu item-->
                                <!--begin::Menu item-->
        ...
        <div class="modal-dialog modal-dialog-centered mw-650px">
            ...
            <div class="modal-content">
                ...
                <div class="modal-header">
                    <!--begin::Modal title-->
                    <h2 class="fw-bolder">Export @if($parent == 0)Estimates @else Invoices @endif</h2>
                    <!--end::Modal title-->
                    <!--begin::Close-->
